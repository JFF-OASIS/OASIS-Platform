...
public class MaterialService {
    ...
    private static final String prefix = "oasis/file/class/";
    ...
    private String gerFileUrl(String key){
    ...
    public ResponseVO uploadFile(MultipartFile multipartFile,
        ...
        String key = prefix + classId.toString() + "/" + type + "/" + fileName;
    ...
    public ResponseVO uploadHomework(MultipartFile file, Long studentId) {
        return new ResponseVO(ResultCode.SUCCESS, "上传成功");
    }
}
